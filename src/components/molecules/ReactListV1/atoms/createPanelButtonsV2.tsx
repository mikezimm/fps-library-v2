 ...
 */
export function createPanelButtonsV2 ( quickCommands: IQuickCommandsDesign, item: IDrillItemInfo , sourceUserInfo: IUser, _panelButtonClicked: any, delim: string ) {
                          ...
                          const thisButton = b.primary === true ?
                            ...
                            //
                                <div id={ buttonID } title={ buttonTitle } >
                                  <PrimaryButton style= { buttonStyles } iconProps= { buttonIcon } text={b.label} onClick={ () => _panelButtonClicked( b, item ) } disabled={b.disabled} checked={b.checked} /></div>:

                                  <div id={ buttonID } title={ buttonTitle } >
                                    <DefaultButton style= { buttonStyles } iconProps= { buttonIcon } text={b.label} onClick={ () => _panelButtonClicked( b, item ) } disabled={b.disabled} checked={b.checked} /></div>;
