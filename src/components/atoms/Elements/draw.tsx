...
export const ColoredLine = ( props: IColoredLine ) => ( <hr style={{ color: props.color, backgroundColor: props.color, height: props.height }}/> );

export const defProjectIconStyle: IDefIcon = {
  name: null,
  color: null,
  size: null,
  weight: null,
...
export function MyIcon(item: any, defIcon: IDefIcon) {
