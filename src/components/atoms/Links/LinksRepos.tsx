...
export const gitRepoFpsLibraryV2: IRepoLinks = createRepoLinks( baseMyRepos + 'fps-library-v2','_blank', 'fps-library-v2', 'legacy' );
export const gitRepoFpsStyles: IRepoLinks = createRepoLinks( baseMyRepos + 'fps-styles','_blank', 'fps-styles', 'legacy' );
export const gitRepoFpsPnp2: IRepoLinks = createRepoLinks( baseMyRepos + 'fps-pnp2','_blank', 'fps-pnp2', 'legacy' );
