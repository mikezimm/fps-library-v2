...
export const EasyDevFPSStyles: IEasyLink = { title: 'FPS-Styles', description: `fps-styles contains JS based functions, interfaces and constants for reuse - ${EasyPagesDevTab}`, 
  url: 'https://github.com/mikezimm/fps-Styles/issues' , imageUrl: 'https://www.freepnglogos.com/uploads/javascript-png/black-js-logo-symbol-icon-29.png' , type: 'current', tabs: [ EasyPagesDevTab ] } as any;

export const EasyDevFPSLibraryV2: IEasyLink = { title: 'FPS-Library-v2', description: `fps-library-v2 contains react based banner for reuse - ${EasyPagesDevTab}`, 
